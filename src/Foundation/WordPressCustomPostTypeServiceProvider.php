...
use WPScotty\WPSpock\Support\ServiceProvider;
use WPScotty\WPSpock\Foundation\Http\Request;
...
/**
 * Class WordPressCustomPostTypeServiceProvider
 *
 * @package WPScotty\WPSpock\Foundation
 * @author  WPScotty
 * @since   1.0.0
 * @version 1.0.0
...
abstract class WordPressCustomPostTypeServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $slug = "wpnceasywp_slug";
     ...
     * @var string
     */
    protected $queryVar = 'wpnceasywp_vars';
